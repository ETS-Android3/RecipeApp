...
public class RecipeArchive {
    ...
    public ArrayList<Recipe> createInitialRecipes() {
        ...
        recipes.add(new Recipe("Spaghetti and meatballs", listRecipeFragment.getContext().getDrawable(R.drawable.spaghetti),
                listRecipeFragment.getContext().getDrawable(R.drawable.spaghetti_2), ingredients, instructions));
        ...
        recipes.add(new Recipe("Cottage Pie", listRecipeFragment.getContext().getDrawable(R.drawable.cottage_pie),
                listRecipeFragment.getContext().getDrawable(R.drawable.cottage_pie2), ingredients, instructions));
        ...
        recipes.add(new Recipe("Crab Rangoon", listRecipeFragment.getContext().getDrawable(R.drawable.crab_rangoon),
                listRecipeFragment.getContext().getDrawable(R.drawable.crab_rangoon2), ingredients, instructions));
        ...
        recipes.add(new Recipe("Zaru Soba", listRecipeFragment.getContext().getDrawable(R.drawable.zaru_soba),
                listRecipeFragment.getContext().getDrawable(R.drawable.zaru_soba2), ingredients, instructions));
        ...
        recipes.add(new Recipe("Chicken Enchiladas", listRecipeFragment.getContext().getDrawable(R.drawable.chicken_enchiladas),
                listRecipeFragment.getContext().getDrawable(R.drawable.chicken_enchiladas2), instructions, ingredients));
        ...
        recipes.add(new Recipe("Beef Stir-Fry", listRecipeFragment.getContext().getDrawable(R.drawable.beef_stirfry),
                listRecipeFragment.getContext().getDrawable(R.drawable.beef_stirfry2), ingredients, instructions));
        return recipes;
    }
}
